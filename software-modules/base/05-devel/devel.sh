...
#	devel.sh
#	Script to build the development tools huronOS System Layer (.hsl)
#	for huronOS image. It packs the build essential tools to compile
#	and build software.
#	This system layer should only be include on development builds
#
...
savechanges /tmp/05-devel.hsl
cp /tmp/05-devel.hsl /run/initramfs/memory/system/huronOS/base --verbose
